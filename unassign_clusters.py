...
def unassign_clusters(host, protocol, port, username, password,
                      unified_dataset_name, usernames,
                      cluster_ids):

    with TamrAPI(host, protocol, port, username, password) as api:
        response = api.unassign_clusters(unified_dataset_name=unified_dataset_name,
                                         usernames=usernames,
...
if __name__ == '__main__':
    ...
    unassign_clusters(host=args.host,
